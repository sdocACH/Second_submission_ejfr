...
% - metric of residual inflation (% or perc.points?) -> section 'Added Value of Tree Species Map Information', 'Effect of Misclassification'
% - ceck sample sizes / also of missing tspec plots
% - misclassification(S)?
